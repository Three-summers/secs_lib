...
public:
     ...
     */
    virtual asio::awaitable<std::pair<std::error_code, TResponse>>
    handle(const TRequest &request, const DataMessage &raw) = 0;
...
void register_typed_handler(Router &router,
                            std::uint8_t stream,
